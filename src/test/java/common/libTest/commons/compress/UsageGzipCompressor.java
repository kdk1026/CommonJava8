...
public class UsageGzipCompressor {

	public static void main(String[] args) {
		/*File src = new File("C:\\test2\\simpleChat");
		File destFile = new File("C:\\test2\\simpleChat2.tar.gz");

		compress(src, destFile);*/

		File srcFile = new File("C:\\test2\\simpleChat2.tar.gz");
